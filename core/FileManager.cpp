...
bool FileManager::saveUsers(const vector<User>& users) {
    ...
    if (!file.is_open()) {
        printError("Error: Could not open users file for writing.");
        return false;
    }
...
bool FileManager::addUser(const User& user) {
    ...
    if (!file.is_open()) {
        printError("Error: Could not open users file.");
        return false;
    }
...
bool FileManager::saveRechargeRequests(const vector<RechargeRequest>& requests) {
    ...
    if (!file.is_open()) {
        printError("Error: Could not open recharge requests file for writing.");
        return false;
    }
...
bool FileManager::addRechargeRequest(const RechargeRequest& request) {
    ...
    if (!file.is_open()) {
        printError("Error: Could not open recharge requests file.");
        return false;
    }
...
bool FileManager::saveTokens(const vector<Token>& tokens) {
    ...
    if (!file.is_open()) {
        printError("Error: Could not open tokens file for writing.");
        return false;
    }
...
bool FileManager::addToken(const Token& token) {
    ...
    if (!file.is_open()) {
        printError("Error: Could not open tokens file.");
        return false;
    }
